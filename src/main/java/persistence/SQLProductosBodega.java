...
private final static String SQL = PersistenciaSuperAndes.SQL;
	...
	public void agregarProductosBodega (PersistenceManager pm,long idBodega,int cantidad, long idProductoSucursal) 
	{
	...
	public void descontarProductoSucursalDeBodegaEnCantidad (PersistenceManager pm,long idBodega,int cant,long idProductoSucursal)
	{
	...
	public void abastecerProductoSucursalDeBodegaEnCantidad (PersistenceManager pm,long idBodega,int cant,long idProductoSucursal)
	{
	...
	public ProductosBodega darProductoBodega (PersistenceManager pm, long idBodega, long idProductoSucursal )
	{
		Query q = pm.newQuery(SQL, "SELECT * FROM "+ pp.darTablaProductosVendidos()+ " WHERE idBodega=? AND idProductoSucursal=?");
	...
	public int darCantidadProductoSucursalDeBogega (PersistenceManager pm, long idBodega, long idProductoSucursal )
	{
		Query q = pm.newQuery(SQL, "SELECT cantidad FROM "+ pp.darTablaFacturasCompradores()+ " WHERE idBodega= ? AND idProductoSucursal=?");
		q.setParameters(idBodega,idProductoSucursal);
