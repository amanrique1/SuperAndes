...
CREATE TABLE TIPOPRODUCTO
   (nombreTipo VARCHAR2(255 BYTE), 
    ...
    CONSTRAINT CK_METODALMAC_F_TPRODUCTO
        CHECK (metodoAlmacenamiento IN ('Refrigeramiento','Sin Especificar','Seco')),
...
CREATE TABLE PRODUCTOSSUCURSAL
   (idProductoSucursal VARCHAR2(255 BYTE),
    ...
    CONSTRAINT CK_PRECIOPOS_F_PRODSSUCUR
        CHECK (precio >=0),
    CONSTRAINT CK_CANTPROD_F_PRODSUCUR 
...
-- Creaación de la tabla CARRITOPRODUCTOSy especificación de sus restricciones
